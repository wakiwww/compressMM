  ...
  return (
    <div style={styles.container}>
      <header style={styles.header}>
        <h1 style={styles.title}>werck it!</h1>
        <p style={styles.subtitle}>video degrader</p>
      </header>

      <main style={styles.main}>
        <section style={styles.section}>
          <h2 style={styles.sectionTitle}>欢迎访问 werck it! 官方网站</h2>
          <p style={styles.text}>
            werck it!是一款创新的视频处理工具，通过先进的算法为您的视频添加独特的艺术效果。
          </p>
        </section>

        <section style={styles.section}>
          <h2 style={styles.sectionTitle}>重要链接</h2>
          <div style={styles.links}>s
